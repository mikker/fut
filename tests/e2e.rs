...
use fut::{
    ...
    protocol::{
        ClientMessage, ClientMode, Envelope, PROTOCOL_VERSION, PresentationTokenPublishAction,
...
async fn compiled_rust_extension_conforms_through_public_fut_boundaries() {
    ...
    .await;
    // The command records its side effect before its temporary PTY exits, and
