...
The current development protocol is `3` and requires an exact client/daemon match. A successful handshake reports a compatible protocol-`3` daemon; any other protocol version is incompatible.
