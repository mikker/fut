...
The current development protocol is `5` and requires an exact client/daemon match. A successful handshake reports a compatible protocol-`5` daemon; any other protocol version is incompatible.
