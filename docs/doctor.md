...
The current development protocol is `4` and requires an exact client/daemon match. A successful handshake reports a compatible protocol-`4` daemon; any other protocol version is incompatible.
