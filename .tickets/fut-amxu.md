...
Follow-up: compacted single-pane tabs into one navigator row with a muted pane suffix and added truncated session/workspace/tab scope breadcrumbs. Refactor pass made the inline pane identity explicit. Validation: cargo test passed (431 unit tests and 99 E2E tests).
