...
- Truecolor, undercurl, hyperlinks, focus events, focused-application click forwarding, and extended keyboard protocols. (Bracketed paste, pane click focus, and mode-aware wheel forwarding are implemented.)
