...
- Added a searchable `fut --ui-playground`, configurable text spinners, and restrained pulse and wave effects that animate complete pills.
- Fixed Linux arm64 release binaries crashing with illegal instructions on CPUs without SVE.
- Cleared the terminal canvas before rendering Fut's first interactive frame.
